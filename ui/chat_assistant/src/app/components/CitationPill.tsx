...
export function CitationPill({ guidelineId, section, sourceText, onClick, isActive = false }: CitationPillProps) {
  ...
  return (
    <span className="relative inline-block">
      ...
      {showTooltip && (
        <span className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-80 -translate-x-1/2 block">
          <span
          ...
          >
            ...
            <span className="mt-1 block text-xs leading-relaxed text-gray-700">
              "{sourceText.length > 240 ? sourceText.slice(0, 240) + '…' : sourceText}"
            </span>
          </span>
          <span
